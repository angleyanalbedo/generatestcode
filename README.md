...
* **深度质检 (Anltr4)**：又基于 `Anltr4` 库构建 ST Parser
...
| **`augment_dataset.py`** | **[核心]** 基于 AST 与数据依赖分析的无损 ST 代码增强（指令乱序、等价变换、变量混淆）。 | 扩充高质量 SFT 训练集，提升大模型对 ST 代码生成的泛化能力与语法鲁棒性。 |
...
[ST_Slicing](https://github.com/oneqiao/ST_Slicing)

[PLCBEAD](https://github.com/AICPS/PLCBEAD_PLCEmbed)

[blank734](https://github.com/blank374) 的蒸馏部分
